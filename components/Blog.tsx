        ...
        <section className="flex items-center justify-center flex-col">
            <div className="flex flex-col mx-auto max-w-[1440px] relative w-full p-6">
                ...
                <div className="bg-white flex flex-col justify-start p-6">
                    <a href="/blog/relaxing-on-the-riverbank" className="text-[36px] font-[700] leading-[120%]
                    lg:text-[52px] lg:font-[700] lg:leading-[120%] pb-4">
                        Relaxing on the Riverbank of Leuwimalang Village
                    </a>
                    <a href="/blog/relaxing-on-the-riverbank" className="pb-6">
            ...
            <div className="container mx-auto flex flex-wrap py-6">
                ...
                <div className="px-6 lg:px-20 3xl:px-0 mx-auto max-w-[1440px] w-full pb-24">
                    ...
                    <article className="md:flex md:w-full shadow-lg my-4">
                        <Link href="/blog/the-farming-process" className="hover:opacity-75 flex justify-center items-center">
                            <Image
                                src={'/blog-post1.png'}
                                alt={'blog-post1'}
                                width={300}
                        ...
                        <div className="bg-white flex flex-col justify-start p-6">
                            <Link href="/blog/the-farming-process" className="text-3xl font-bold hover:text-gray-700 pb-4">
                                The Farming Process in Leuwimalang Village
                            </Link>
                            <Link href="/blog/the-farming-process" className="pb-6">
                    ...
                    <article className="md:flex md:w-full shadow-lg my-4">
                        <Link href="/blog/enjoying-the-cool-air" className="hover:opacity-75 flex justify-center items-center">
                            <Image
                                src={'/blog-post2.png'}
                                alt={'blog-post2'}
                                width={300}
                        ...
                        <div className="bg-white flex flex-col justify-start p-6">
                            <Link href="/blog/enjoying-the-cool-air" className="text-3xl font-bold hover:text-gray-700 pb-4">
                                Enjoying the Cool Air While Trekking in Leuwimalang
                            </Link>
                            <Link href="/blog/enjoying-the-cool-air" className="pb-6">
                    ...
                    <article className="md:flex md:w-full shadow-lg my-4">
                        <Link href="/blog/typical-culinary" className="hover:opacity-75 flex justify-center items-center">
                            <Image
                                src={'/blog-post3.png'}
                                alt={'blog-post3'}
                                width={300}
                        ...
                        <div className="bg-white flex flex-col justify-start p-6">
                            <Link href="/blog/typical-culinary" className="text-3xl font-bold hover:text-gray-700 pb-4">
                                Typical Culinary in Leuwimalang
                            </Link>
                            <Link href="/blog/typical-culinary" className="pb-6">
                    ...
                    <article className="md:flex md:w-full shadow-lg my-4">
                        <Link href="/blog/educational-tour" className="hover:opacity-75 flex justify-center items-center">
                            <Image
                                src={'/blog-post4.png'}
                                alt={'blog-post4'}
                                width={300}
                        ...
                        <div className="bg-white flex flex-col justify-start p-6">
                            <Link href="/blog/educational-tour" className="text-3xl font-bold hover:text-gray-700 pb-4">
                                Educational Tour in Leuwimalang
                            </Link>
                            <Link href="/blog/educational-tour" className="pb-6">
                    ...
                    <div className="flex justify-center items-center py-8 gap-1">
                        ...
                        <a href="#" className="rounded h-10 w-10 font-semibold text-black hover:text-olivine text-sm flex items-center justify-center ml-3">
